...
export async function resetPatientsAndSeedDemo() {
  ...
  db.transaction(() => {
    ...
    insertChat.run(
      pB,
      'ai',
      '收到，我先帮您把信息补齐：\n1）胃痛位置大概在上腹正中还是偏左/偏右？\n2）反酸/烧心是否与进食有关？空腹会不会更痛？\n3）有没有恶心呕吐、黑便/便血、体重明显下降？\n4）近期是否熬夜、饮酒、咖啡/辛辣增加？\n5）是否在用止痛药（如布洛芬等）？\n6）既往胃炎/胃溃疡/幽门螺杆菌史？',
    ...
    insertChat.run(
      pC,
      'ai',
      '收到。为了让医生更快判断，我先问几个关键点：\n1）最近一周最高/最低血压大概多少？测量是在安静坐位吗？\n2）头晕是旋转感还是发飘？有没有胸闷、心悸、视物模糊？\n3）目前在用哪些降压药、降糖药？有无漏服/自行加量？\n4）最近盐摄入、饮酒、睡眠、情绪、活动量有没有变化？\n5）有没有手脚麻木、说话含糊、单侧无力等情况？',
